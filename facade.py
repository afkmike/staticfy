...
class main_window(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Staticfy Django Integration Tool", pos=wx.DefaultPosition,
                          size=wx.Size(964, 552), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.m_staticText6 = wx.StaticText(self, wx.ID_ANY, u"Choose Processing Method", wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        self.m_staticText6.Wrap(-1)
        bSizer99.Add(self.m_staticText6, 0, wx.ALL, 5)

        processing_type_comboChoices = [u"Single File", u"Whole Dir"]
        self.processing_type_combo = wx.ComboBox(self, wx.ID_ANY, u"Single File", wx.DefaultPosition, wx.DefaultSize,
                                                 processing_type_comboChoices, 0)
        ...
        self.file_type_selector = wx.ComboBox(self, wx.ID_ANY, u"HTML", wx.DefaultPosition, wx.DefaultSize,
                                              file_type_selectorChoices, 0)
        ...
        self.console = wx.TextCtrl(self, wx.ID_ANY,
                                   u"Log contents will be displayed here. You can also find a copy of the log in your Staticfy/logs folder.",
...
class diff_view(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Filename + Diff View", pos=wx.DefaultPosition,
                          size=wx.Size(982, 589), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        m_comboBox1Choices = []
        self.files_combo = wx.ComboBox(self, wx.ID_ANY, u"", wx.DefaultPosition, wx.DefaultSize,
                                       m_comboBox1Choices, 0)
        bSizer14.Add(self.files_combo, 0, wx.ALL, 5)

        self.m_button9 = wx.Button(self, wx.ID_ANY, u"Show", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_textCtrl2 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                       wx.HSCROLL | wx.TE_DONTWRAP | wx.TE_MULTILINE | wx.TE_READONLY)
        sbSizer1.Add(self.m_textCtrl2, 1, wx.ALL | wx.EXPAND, 5)

        bSizer16.Add(sbSizer1, 1, wx.EXPAND, 5)

        sbSizer2 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, u"Modified File"), wx.VERTICAL)

        self.m_textCtrl21 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                        wx.HSCROLL | wx.TE_DONTWRAP | wx.TE_MULTILINE | wx.TE_READONLY)
        sbSizer2.Add(self.m_textCtrl21, 1, wx.ALL | wx.EXPAND, 5)
